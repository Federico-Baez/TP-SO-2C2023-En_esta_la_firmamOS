...
typedef enum{
	...
	LECTURA_MARCO_DE_SWAP_MF,
	RPTA_LECTURA_MARCO_DE_SWAP_FM,
	BLOQUE_DE_MEMORIA_A_FILESYSTEM_FM,
	BLOQUE_DE_FILESYSTEM_A_MEMORIA_FM,
	RPTA_BLOQUE_DE_FILESYSTEM_A_MEMORIA_FM,
	//------- CPU - MEMORIA
